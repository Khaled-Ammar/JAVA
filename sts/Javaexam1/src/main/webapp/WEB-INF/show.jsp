...
<button type="button" onclick=""><a href="/return/${book.id}" >out</a> </button>
...
<c:choose>
    <c:when test="${book.parow==false }">
	 ...
	 <option value="${user.id}">${book.id} , ${book.user.userName}    </option>
...
<button type="button" onclick=""><a href="/borrow/${book.id}" >goin </a> </button>
