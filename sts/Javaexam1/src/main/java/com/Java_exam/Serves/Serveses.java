...
import com.Java_exam.Reposotry.Reposetroy;
import com.Java_exam.Reposotry.bookRepo;
...
// public User findLookify(Long id) {
//		Optional<User> lookify = userRepo.findById(id);
...
//	}
// 
// public Book findCat(Long id) {
//		Optional<Book> lookify1 = bookRepo.findById(id);
...
//	}
// public Book updateCat(Book product) {
