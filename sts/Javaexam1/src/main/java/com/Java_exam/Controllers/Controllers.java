package com.Java_exam.Controllers;
...
import com.Java_exam.Models.Login;
import com.Java_exam.Models.User;
import com.Java_exam.Serves.Serveses;
...
//				    	model.addAttribute("show",Serveses.findLookify(id));
//				    	 User product = Serveses.findLookify(id);
//				    	model.addAttribute("allcat",Serveses.allproductbycat(product));
//				        
//				    	model.addAttribute("procat",Serveses.(product));
//				    	
//
//				    	
//				    	return "show.jsp";
...
//				        User product = Serveses.findLookify(id);
//				        Book category = Serveses.findCat(catId);
//				    	product.getUserName().add(category);
//				    	Serveses.updateProduct(product);
//				    	Long ids=id;
